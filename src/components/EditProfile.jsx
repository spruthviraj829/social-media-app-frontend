...
import { UserLogin, updatepdateProfile } from "../redux/userSlice";
...
const EditProfile = () => {
  ...
  const {register ,handleSubmit ,formState: {errors}} = useForm({mode: "onChnage" ,  defaultValues: { ...user }})
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if(res?.message === "failed"){
        ...
        setTimeout(() => {
          dispatch(updatepdateProfile(false))
        }, 3000);
      }
